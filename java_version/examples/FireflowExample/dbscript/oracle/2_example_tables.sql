...
create table T_BIZ_LOAN_APPROVEINFO (ID varchar2(50 char) not null, SN varchar2(50 char) not null, approver varchar2(50 char) not null, decision number(1,0), detail varchar2(50 char) not null, primary key (ID));
