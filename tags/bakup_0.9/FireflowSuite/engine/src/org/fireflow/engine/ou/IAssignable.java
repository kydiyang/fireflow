...
public interface IAssignable {
     ...
     * @param actorId 操作员Id
     * @param needSign 是否需要签收，true表示需要操作员执行签收动作,系统将WorkItem设置为INITIALIZED状态；false不需要签收，Workitem直接被设置为STARTED状态。
     * @throws org.fireflow.engine.EngineException
     * @throws org.fireflow.kenel.KenelException
     */
    public void asignToActor(String actorId, boolean needSign) throws EngineException, KenelException;
     ...
     * @throws org.fireflow.kenel.KenelException
     */
    public void asignToActor(String actorId) throws EngineException, KenelException;
     ...
     * @throws org.fireflow.kenel.KenelException
     */
    public void asignToActors(List<String> actorIds) throws EngineException, KenelException;
}
