...
public class EndNodeMarqueeHandler extends BasicMarqueeHandler {

    private ProcessDesignPanel designPanel = null;
    private ProcessDesignMediator mediator = null;

    public EndNodeMarqueeHandler(ProcessDesignMediator md,
    ...
    public void mousePressed(MouseEvent mouseEvent) {
        ...
        IFPDLElement newEndNodeElement = graphModel.getWorkflowProcessElement().createChild(IFPDLElement.END_NODE, attributeMap);
