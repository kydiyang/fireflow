...
//import cn.bestsolution.bsflow.core.ExtendedAttributeNames;
import org.fireflow.model.ExtendedAttributeNames;

public class ActivityWithFormMarqueeHandler extends BasicMarqueeHandler {

    private ProcessDesignPanel designPanel = null;
    private ProcessDesignMediator mediator = null;

    public ActivityWithFormMarqueeHandler(ProcessDesignMediator md, ProcessDesignPanel designPanel) {
        mediator = md;
    ...
    public void mousePressed(MouseEvent mouseEvent) {
        ...
        attributeMap.put(ExtendedAttributeNames.BOUNDS_X, Integer.toString(mouseEvent.getPoint().x));
        attributeMap.put(ExtendedAttributeNames.BOUNDS_Y, Integer.toString(mouseEvent.getPoint().y));
        ...
        newActivityElement.createChild(IFPDLElement.FORM_TASK, null);
