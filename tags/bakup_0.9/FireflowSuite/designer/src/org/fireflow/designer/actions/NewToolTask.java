 ...
 *
 */
public class NewToolTask extends AbstractAction implements INewWfElementPosition {
     ...
     * @param icon
     */
    public NewToolTask(ExplorerManager explMgr, String argTtitle, ImageIcon icon) {
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (nodes.length > 0) {
            ...
            if (workflowElm.getElementType().equals(IFPDLElement.ACTIVITY)) {
                ...
                activityElement.createChild(IFPDLElement.TOOL_TASK, null);
            }
        }
