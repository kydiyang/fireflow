...
public class StartNodeCellView extends VertexView {

    private static VertexRenderer myRenderer = new StartNodeRenderer();

    public StartNodeCellView(Object cell) {
        super(cell);
    }
    ...
    public static class StartNodeRenderer extends VertexRenderer {
...
//			super.paint(g);
            ...
            int[] xArr = new int[3];
            int[] yArr = new int[3];
            xArr[0] = (int) (0.8 * (d.width));
            xArr[1] = (int) (0.3 * (d.width));
            xArr[2] = (int) (0.3 * (d.width));
            yArr[0] = (int) (0.5 * (d.height));
