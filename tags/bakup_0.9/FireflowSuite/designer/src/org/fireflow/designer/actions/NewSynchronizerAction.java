...
public class NewSynchronizerAction extends AbstractAction implements INewWfElementPosition {

    Point2D newWfElementPoition;
    ExplorerManager explorerManager = null;
    WorkflowProcessElement workflowProcessElement = null;

    public NewSynchronizerAction(ExplorerManager explMgr, String title, Icon image) {
        super(title, image);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        workflowProcessElement.createChild(IFPDLElement.SYNCHRONIZER, attributeMap);
