 ...
 * 
 */
public class NewSubflowTask extends AbstractAction implements INewWfElementPosition {
     ...
     * @param icon
     */
    public NewSubflowTask(ExplorerManager explMgr, String argTtitle, ImageIcon icon) {
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (nodes.length > 0) {
            ...
            if (workflowElm.getElementType().equals(IFPDLElement.ACTIVITY)) {
                ...
                activityElement.createChild(IFPDLElement.SUBFLOW_TASK, null);
            }
        }
