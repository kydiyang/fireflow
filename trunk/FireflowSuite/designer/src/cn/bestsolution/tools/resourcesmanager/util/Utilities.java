...
//        public static final ResourceBundle resource =  ResourceBundle.getBundle(
//          "cn.bestsolution.tools.resourcesmanager.resources.MainFrameResources",new Locale("zh","CN"));
    public static final java.awt.Font windowsUIFont = new Font("Serif", Font.PLAIN, 12);
    // =========================================================================
    /**
