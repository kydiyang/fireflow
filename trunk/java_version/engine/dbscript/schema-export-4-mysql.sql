...
create table T_FF_DF_WORKFLOWDEF (ID varchar(50) not null, PROCESS_ID varchar(100) not null, DEFINITION_TYPE varchar(100) not null, NAME varchar(100) not null, DISPLAY_NAME varchar(128), DESCRIPTION text, VERSION integer not null, STATE bit not null, UPLOAD_USER varchar(50), UPLOAD_TIME datetime, PUBLISH_USER varchar(50), PUBLISH_TIME datetime, PROCESS_CONTENT text, primary key (ID));
