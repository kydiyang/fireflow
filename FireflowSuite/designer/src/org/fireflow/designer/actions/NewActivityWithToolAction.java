...
public class NewActivityWithToolAction extends AbstractAction implements INewWfElementPosition {

    Point2D newWfElementPoition;
    ExplorerManager explorerManager = null;
    WorkflowProcessElement workflowProcessElement = null;

    public NewActivityWithToolAction(ExplorerManager explMgr, String title, Icon image) {
        super(title, image);
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        IFPDLElement newActivityElement = workflowProcessElement.createChild(IFPDLElement.ACTIVITY, attributeMap);

        newActivityElement.createChild(IFPDLElement.TOOL_TASK, null);
