...
public class StartNodeMarqueeHandler extends BasicMarqueeHandler {

    private ProcessDesignPanel designPanel = null;
    private ProcessDesignMediator mediator = null;

    public StartNodeMarqueeHandler(ProcessDesignMediator md,
    ...
    public void mousePressed(MouseEvent mouseEvent) {
        ...
        WorkflowProcessElement workflowProcessElement = graphModel.getWorkflowProcessElement();

        WorkflowProcess workflowProcess = workflowProcessElement.getLookup().lookup(WorkflowProcess.class);
        ...
        workflowProcessElement.createChild(IFPDLElement.START_NODE, attributeMap);
    }
}
